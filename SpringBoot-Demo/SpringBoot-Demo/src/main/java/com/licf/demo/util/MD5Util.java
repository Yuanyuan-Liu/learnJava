...
public class MD5Util {
	...
	public static void main(String... args) {
		String strMD5 = "123456";

		System.out.println("原始：" + strMD5);
		System.out.println("普通MD5后1：" + getStrrMD5(strMD5));
		System.out.println("普通MD5后2：" + getStrMD5(strMD5));
		System.out.println("加密的：" + getconvertMD5(strMD5));
		System.out.println("解密的：" + getconvertMD5(getconvertMD5(strMD5)));

		System.out.println("\t\t=======================================");
		// 原文
		String plaintext = "licanfeng";
		plaintext = "123456";
		System.out.println("原始：" + plaintext);
		System.out.println("普通MD5后：" + getStrMD5(plaintext));
		...
		for (String temp : tempSalt) {
			System.out.println("是否是同一字符串:" + getSaltverifyMD5(plaintext, temp));
		}
	}
}
