...
import com.licf.demo.common.shiro.CredentialsMatcher;
import com.licf.demo.common.shiro.SessionControlFilter;
import com.licf.demo.common.shiro.SessionManager;
import com.licf.demo.common.shiro.ShiroRealm;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
        ...
        //所有请求都不拦截，直接放行，然后可以通过注解在controller进行注解访问权限
    ...
    public RedisCacheManager cacheManager() {
        ...
        redisCacheManager.setKeyPrefix("demo_CACHE:");   //设置前缀
    ...
    public RedisSessionDAO redisSessionDAO() {
        ...
        redisSessionDAO.setKeyPrefix("SESSION_demo:");
    ...
    public SessionManager sessionManager() {
        SimpleCookie simpleCookie = new SimpleCookie("x-auth-token");
